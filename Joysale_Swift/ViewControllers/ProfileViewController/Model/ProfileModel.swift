...
class ProfileResultModel{
    ...
    var donateDetails : DonateDetailModel!          //MARK: Custom Work
    var membership_enable : String!
    var userId : Int!
    var userImg : String!
    var userName : String!
    ...
    init(fromJson json: JSON!){
        ...
        let donateDetailsJson = json["donate"]      //MARK: Custom Work
        if !donateDetailsJson.isEmpty{
            donateDetails = DonateDetailModel(fromJson: donateDetailsJson)
        }
...
class DonateDetailModel{                                        //MARK: Custom Work
    var pageName : String!
