...
//            self.followerModel = rootClass
    ...
    public func getFollwerData(user_id: String,offset: String, onSuccess success: @escaping (Bool) -> Void, onFailure failure: @escaping (String) -> Void) {
    ...
    public func getFollowingData(user_id: String,offset: String, onSuccess success: @escaping (Bool) -> Void, onFailure failure: @escaping (String) -> Void) {
        let parameter: [String: Any] = ["user_id":user_id, "offset": offset, "limit": "20"]
    ...
    public func getReviewDeta(user_id: String,offset: String, onSuccess success: @escaping (Bool) -> Void, onFailure failure: @escaping (String) -> Void) {
        let parameter: [String: Any] = ["user_id":user_id, "offset": offset, "limit": "20"]
