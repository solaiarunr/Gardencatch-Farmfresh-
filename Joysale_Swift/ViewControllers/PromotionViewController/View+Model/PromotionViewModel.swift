...
class PromotionViewModel {
    ...
    public func processingPayment(user_id: String,item_id: String,promotion_id: String, currency_code: String, pay_nonce: String, payment_type: String, onSuccess success: @escaping (Bool) -> Void, onFailure failure: @escaping (String) -> Void) {
        let parameter: [String: Any] = ["user_id": user_id, "lang_type": DEFAULT_LANGUAGE_CODE, "item_id": item_id, "promotion_id":promotion_id, "currency_code": currency_code, "pay_nonce": pay_nonce, "payment_type": payment_type]
