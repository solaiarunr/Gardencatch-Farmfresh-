...
//        self.hideView.backgroundColor = chat_bg
    ...
    func configUI() {
        ...
        self.ForgotemailTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "email")
        ...
        self.signupButton.config(color: UIColor(named: "AppThemeColor"), font: UIFont(name: APP_FONT_REGULAR, size: 15), align: .center, title: "signup_not_member")
        self.ResetButton.config(color: UIColor(named: "AppThemeColor"), font: UIFont(name: APP_FONT_BOLD, size: 15), align: .center, title: "reset")
        self.cancelButton.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_BOLD, size: 15), align: .center, title: "cancel")

        self.signupButton.cornerMiniumRadius()
        self.loginButton.cornerMiniumRadius()
        self.signupButton.setBorder(color: UIColor(named: "AppThemeColor"))
        self.signupButton.backgroundColor = UIColor(named: "clearcolor")
        self.loginButton.backgroundColor = UIColor(named: "AppThemeColor")
        ...
        self.forgotErrorLabel.config(color: UIColor(named: "AppThemeColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "")
        ...
        self.backButton.setImage(#imageLiteral(resourceName: "takeclose").imageFlippedForRightToLeftLayoutDirection(), for: .normal)
    }
    @objc func forgotAct() {
...
//            set.insert(charactersIn: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLKMNOPQRSTUVWXYZ0123456789")
           // let encodedPassword = self.passwordTextField.text
            //?.addingPercentEncoding(withAllowedCharacters: set) ?? ""
            self.view.endEditing(true)
            self.viewModel.login(email: self.emailTextField.text!, password: self.passwordTextField.text!, onSuccess: { (success) in
