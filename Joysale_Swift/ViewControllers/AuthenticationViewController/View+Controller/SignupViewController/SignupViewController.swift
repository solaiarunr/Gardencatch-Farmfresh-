...
class SignupViewController: UIViewController {
    ...
    @IBOutlet var newStack: UIStackView!
    ...
    override func viewDidLoad() {
        ...
        //self.backButton.frame = CGRect.init(x: FULL_WIDTH-100, y: 54, width: 30, height: 30)
        //self.newStack.layer.cornerRadius = 10
    ...
    func configUI() {
        ...
        self.emailTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "email")
        ...
        self.passwordTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "password")
        ...
        self.confirmPasswordTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "confirmpassword")
        ...
        self.userNameTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "username")
        ...
        self.fullNameTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "fullname")
        ...
        self.mobileTitleLabel.config(color: UIColor(named: "SignSignupTextColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "mobile")
        ...
        self.loginButton.config(color: UIColor(named: "AppThemeColor"), font: UIFont(name: APP_FONT_REGULAR, size: 15), align: .center, title: "already_member_login")
        self.signupButton.cornerMiniumRadius()
        self.loginButton.cornerMiniumRadius()
        self.loginButton.setBorder(color: UIColor(named: "AppThemeColor"))
        self.loginButton.backgroundColor = UIColor(named: "clearcolor")
        self.signupButton.backgroundColor = UIColor(named: "AppThemeColor")
        NotificationCenter.default.addObserver(self, selector: #selector(self.keyboardWillShow(sender:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.keyboardWillHide(sender:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        for errorLabel in errorCollectionLabel {
            errorLabel.config(color: UIColor(named: "AppThemeColor"), font: UIFont(name: APP_FONT_REGULAR, size: 14), align: .left, text: "")
    ...
    @IBAction func authenticationButtonAct(_ sender: UIButton) {
        if sender == loginButton {
            ...
            if self.updateErrorData(self.emailTextField) && self.updateErrorData(self.userNameTextfield) && self.updateErrorData(self.fullNameTextField) && self.updateErrorData(self.passwordTextField) && self.updateErrorData(self.confirmPasswordTextField) { // && self.updateErrorData(self.mobileTextField)
