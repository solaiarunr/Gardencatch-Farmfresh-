...
//        let parameter: [String: Any] = ["type":type, "id":id, "first_name": "Arun", "last_name": "Andiselvam", "email": "iosapps@hitasoft.com", "image_url": image_url, "country_name": country_name, "state_name": state_name, "city_name": city_name]
