...
extension FilterViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        cell.overAllView.backgroundColor = UIColor(named: "BackGroundColor")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.priceSlider.tag = ((indexPath.section*10)+indexPath.row)
    ...
    @objc func distanceSliderAct(_ sender: UISlider) {
        if FILTER_DATA.location != "" && FILTER_DATA.location != "worldwide" && FILTER_DATA.location.lowercased() != CURRENT_LOCATION.lowercased() {
...
extension FilterViewController: SearchDelegate, CategoryDelegate, ProductConditionDelegate, customLocationDelegate { // locationDelegate
    
    // Update Location Data
    func locationAct(city: String, state: String, country: String, countryCode: String,lat: String, long: String, location: String) {
        if location == "worldwide" || location.lowercased() == CURRENT_LOCATION.lowercased(){
            print("hii")
            FILTER_DATA.distance = ""
        }
