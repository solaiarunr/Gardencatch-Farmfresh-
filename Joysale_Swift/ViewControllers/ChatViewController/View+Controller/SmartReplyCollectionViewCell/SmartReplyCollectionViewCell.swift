...
class SmartReplyCollectionViewCell: UICollectionViewCell {
    ...
    func configUI() {
        ...
        self.smartReplyLabel.config(color: UIColor(named: "AppThemeColor"), font: REGULAR_FONT, align: .center, text: "")
     }
    override func layoutSubviews() {
        self.shadowView.setViewMinBorder(color: UIColor(named: "AppThemeColor") ?? .black)
    }
}
