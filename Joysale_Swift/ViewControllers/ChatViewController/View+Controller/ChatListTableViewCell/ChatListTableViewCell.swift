 ...
 class ChatListTableViewCell: UITableViewCell {
     ...
     func loadData(_ chatModel: ChatListResultModel) {
         ...
         if chatModel.lastRepliedto == "0" || chatModel.lastRepliedto != "\(UserDefaultModule.shared.getUserData()?.user_id ?? "")" {
             ...
             self.messageLabel.textColor = UIColor(named: "BlackColor")
             self.userNameLabel.textColor = UIColor(named: "BlackColor")
             self.dateLabel.textColor = UIColor(named: "BlackColor")
