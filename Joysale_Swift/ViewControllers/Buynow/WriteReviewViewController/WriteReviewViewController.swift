...
//    var revie
    ...
    func configUI() {
        self.navigationBar.tintColor = UIColor(named: "whitecolor") ?? .white
        self.navigationBar.barTintColor = UIColor(named: "whitecolor") ?? .white

        self.reviewTitleLabel.config(color: UIColor(named: "appblackcolor"), font: UIFont(name: APP_FONT_BOLD, size: 30), align: .center, text: "Write a review")
        self.reviewDescLabel.config(color: UIColor(named: "appblackcolor"), font: UIFont(name: APP_FONT_REGULAR, size: 18), align: .center, text: "Review and rating based on the experience")
        self.titleLabel.config(color: UIColor(named: "appblackcolor"), font: UIFont(name: APP_FONT_REGULAR, size: 15), align: .left, text: "title")
        self.titleTextField.config(color: UIColor(named: "appblackcolor"), align: .left, placeHolder: "", font: UIFont(name: APP_FONT_REGULAR, size: 15))
        self.reviewLabel.config(color: UIColor(named: "appblackcolor"), font: UIFont(name: APP_FONT_REGULAR, size: 15), align: .left, text: "review")
        self.reviewTextView.config(color: UIColor(named: "appblackcolor") ?? .white, font: UIFont(name: APP_FONT_REGULAR, size: 15), align: .left, text: "")
        ...
        self.submitButton.backgroundColor = UIColor(named: "AppThemeColor")
